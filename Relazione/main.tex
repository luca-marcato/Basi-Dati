...
di tutti i prodotti presenti nel carrello e del costo delle loro spedizioni.
...
\begin{itemize}
    \item Operazione 1: Aggiungere un nuovo prodotto al carrello (50000 al giorno)
    \item Operazione 2: Visualizzare l'importo totale del carrello (75000 al giorno)
\end{itemize}
\textbf{PRESENZA RIDONDANZA}\\
Operazione 1:\\
Vengono inseriti in media 500000 / 250000 = 2 prodotti a carrello
...
\begin{figure}[H]
    \includegraphics[scale=0.44]{media/ER risolto.png}
